# Generated by Django 3.2.12 on 2022-08-11 18:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_room', to='chat.quizroom')),
