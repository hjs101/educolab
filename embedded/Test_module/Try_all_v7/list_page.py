...
class List_Screen(Screen):
    ...
    def content_btn(self, content_num): # List에서 각각의 게시물 들어갈때 페이지 구분
        if content_num > self.deact_flag:
            ...
            # 임시 테스트
            if self.name=="Quiz_list1" or self.name=="Quiz_list2": self.content_page='Quiz_wait'
            ############
        else:
            ...
            elif self.name=='Quiz_list1' or self.name=='Quiz_list2':
                self.content_page='Quiz_wait'
